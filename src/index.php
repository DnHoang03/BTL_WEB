...
<head>
    ...
    <style>
        ...
        header {
            ...
            text-align: center;
            color: #fff;
            background-image: url('https://nld.mediacdn.vn/thumb_w/698/2018/5/26/nhansu-15272952345711312615035.png') !important;
        ...
        <header>
            <div class="header-content">
                <div class="header-content-inner">
                    <h1 style="font-size: 50px;font-weight: bold; color:red;">CÔNG TY GIẢI PHÁP PHẦN MỀM</h1>
                </div>
            </div>
        </header>
        <div class="row">
